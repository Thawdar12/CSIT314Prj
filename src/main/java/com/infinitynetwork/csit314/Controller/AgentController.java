...
public class AgentController {
    ...
    public AgentController(AppUserService appUserService, AppUserRepository appUserRepository,
    ...
    public String agentDashboard(@RequestParam(defaultValue = "0") int page,
