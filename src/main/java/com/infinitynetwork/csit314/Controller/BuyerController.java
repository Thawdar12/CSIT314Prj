...
/**
 * Controller for handling buyer-related operations such as viewing car listings,
 * manage reviews and feedbacks, change user account information
 * loan calculator, manage preferred used car listings
 */
@Controller
...
public class BuyerController {
    ...
    public BuyerController(AppUserService appUserService,
    ...
    /**
     * Displays the buyer dashboard with paginated car listings.
     *
     ...
     * @return View name for the buyer dashboard.
     */
...
//        Page<CarListings> carListingsPage = carListingService.findAllListingsBySellerID(Long.valueOf("3".toString()), page, size);
//        int totalPages = carListingsPage.getTotalPages();
        ...
        return "InfinityNetwork/buyer/dashboard"; // Resolves to 'templates/InfinityNetwork/buyer/dashboard.html'
    }
